      ...
      <body>
        <main className="flex min-h-screen items-center justify-center bg-[#fff8ee] px-4 text-zinc-950">
          <div className="w-full max-w-lg rounded-lg border border-red-100 bg-white p-6 shadow-xl shadow-red-900/5">
            ...
            <h1 className="mt-5 text-3xl font-semibold">therealestatelink hit an error</h1>
            <p className="mt-3 text-sm leading-6 text-zinc-600">
              A server error interrupted the app. Retry the request; if it repeats, the error
              reference can be matched in deployment logs.
            </p>
